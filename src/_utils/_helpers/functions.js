...
Date.prototype.formattedDate = function (date, options = {}) {
...
Date.prototype.formattedTime = function (date, options = {}) {
...
Date.prototype.formattedDateTime = function (date, options = {}) {
  return date.toLocaleTimeString(undefined, {
    ...defaultDateTimeOptions,
    ...options,
  });
...
export const setElementHeightBetweenTwoElements = ({
  ...
  if (elementRef.current) {
    ...
    if (mainWrapperElement.offsetHeight < newHeight) {
